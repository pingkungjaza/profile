...
export const EmailIcon: React.FC<IconSvgProps> = ({
	...
	return (
		...
		>
			<path
				d="m24 5.7v12.8c0 1.5-1.3 2.7-2.8 2.7h-18.4c-1.5 0-2.8-1.2-2.8-2.7v-12.8c0-1.5 1.3-2.7 2.8-2.7h18.4c1.5 0 2.8 1.2 2.8 2.7zm-2.4 12.8v-11.1l-8.3 7q-0.3 0.2-0.6 0.2h-1.4q-0.3 0-0.6-0.2l-8.3-7v11.1c0 0.2 0.2 0.3 0.4 0.3h18.4c0.2 0 0.4-0.1 0.4-0.3zm-1.5-13.1h-16.2l8.1 6.8z"
				fill="currentColor"
			/>
		</svg>
	);
